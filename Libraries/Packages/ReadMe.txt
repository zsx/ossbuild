...
libneon		- 	0.28.6 		- 	http://www.webdav.org/neon/neon-0.28.6.tar.gz
pthreads 	- 	2.8.0 		- 	ftp://sourceware.org/pub/pthreads-win32/pthreads-w32-2-8-0-release.tar.gz
glib 		- 	2.21.4 		- 	http://ftp.gnome.org/pub/gnome/sources/glib/2.21/glib-2.21.4.tar.bz2
proxy-libintl 	- 	20080918 	- 	http://ftp.gnome.org/pub/gnome/binaries/win32/dependencies/proxy-libintl-dev_20080918_win32.zip
libjpeg 	- 	7.0.0 		- 	http://www.ijg.org/files/jpegsrc.v7.tar.gz
libpng 		- 	1.2.39 		- 	http://prdownloads.sourceforge.net/libpng/libpng-1.2.39.tar.gz?download
pango 		-	1.24.5 		- 	http://ftp.gnome.org/pub/GNOME/sources/pango/1.24/pango-1.24.5.tar.bz2
freetype 	- 	2.3.9		- 	http://mirror.its.uidaho.edu/pub/savannah/freetype/freetype-2.3.9.tar.bz2
fontconfig 	- 	2.7.1 		- 	http://fontconfig.org/release/fontconfig-2.7.1.tar.gz
...
pixman 		- 	0.15.20		- 	http://cairographics.org/releases/pixman-0.15.20.tar.gz
...
libsoup 	- 	2.27.90		- 	http://ftp.gnome.org/pub/GNOME/sources/libsoup/2.27/libsoup-2.27.90.tar.bz2
...
gnutls 		- 	2.8.3 		- 	http://ftp.gnu.org/pub/gnu/gnutls/gnutls-2.8.3.tar.bz2
libspeex 	- 	1.2rc1 		- 	http://downloads.xiph.org/releases/speex/speex-1.2rc1.tar.gz
libschrodinger 	- 	1.0.7 		- 	http://diracvideo.org/download/schroedinger/schroedinger-1.0.7.tar.gz
...
libnice 	- 	0.0.9 		- 	http://nice.freedesktop.org/releases/libnice-0.0.9.tar.gz
