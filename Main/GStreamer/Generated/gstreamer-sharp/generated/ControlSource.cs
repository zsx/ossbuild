...
#region Autogenerated code
	public partial class ControlSource : Gst.GLib.Object {

		public ControlSource(IntPtr raw) : base(raw) {}
		...
		static GstControlSourceClass GetClassStruct (Gst.GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Hashtable ();

			if (use_cache && class_structs.Contains (gtype))
				return (GstControlSourceClass) class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				GstControlSourceClass class_struct = (GstControlSourceClass) Marshal.PtrToStructure (class_ptr, typeof (GstControlSourceClass));
				if (use_cache)
		...
		static void OverrideClassStruct (Gst.GLib.GType gtype, GstControlSourceClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
		...
		static extern bool gst_control_source_bind(IntPtr raw, IntPtr pspec);

		public bool Bind(IntPtr pspec) {
			bool raw_ret = gst_control_source_bind(Handle, pspec);
			bool ret = raw_ret;
			return ret;
		}
		...
		[DllImport("libgstcontroller-0.10.dll", CallingConvention = CallingConvention.Cdecl)]
		static extern bool gst_control_source_get_value(IntPtr raw, ulong timestamp, IntPtr value);
