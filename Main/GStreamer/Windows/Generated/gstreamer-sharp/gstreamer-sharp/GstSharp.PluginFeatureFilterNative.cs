...
#region Autogenerated code
	...
	internal class PluginFeatureFilterInvoker {
		...
		internal PluginFeatureFilterInvoker (PluginFeatureFilterNative native_cb, IntPtr data, Gst.GLib.DestroyNotify notify)
		{
		...
		{
			bool result = native_cb (feature == null ? IntPtr.Zero : feature.Handle, __data);
			return result;
		}
	}
	...
	internal class PluginFeatureFilterWrapper {
		...
		{
			try {
				bool __ret = managed (Gst.GLib.Object.GetObject(feature) as Gst.PluginFeature);
				if (release_on_call)
					gch.Free ();
				return __ret;
			} catch (Exception e) {
