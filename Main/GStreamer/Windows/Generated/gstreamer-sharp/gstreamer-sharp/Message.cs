...
#region Autogenerated code
	public class Message : Gst.MiniObject {
		...
		protected Message() : base(IntPtr.Zero)
		{
			CreateNativeObject ();
		}

		[DllImport ("gstreamersharpglue-0.10.dll")]
		extern static uint gstsharp_gst_message_get_type_offset ();

		static uint type_offset = gstsharp_gst_message_get_type_offset ();
		...
		static GstMessageClass GetClassStruct (Gst.GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Hashtable ();

			if (use_cache && class_structs.Contains (gtype))
				return (GstMessageClass) class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				GstMessageClass class_struct = (GstMessageClass) Marshal.PtrToStructure (class_ptr, typeof (GstMessageClass));
				if (use_cache)
		...
		static void OverrideClassStruct (Gst.GLib.GType gtype, GstMessageClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
