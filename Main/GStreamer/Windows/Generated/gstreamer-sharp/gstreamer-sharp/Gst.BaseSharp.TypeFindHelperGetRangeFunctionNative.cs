...
#region Autogenerated code
	...
	internal delegate int TypeFindHelperGetRangeFunctionNative(IntPtr obj, ulong offset, uint length, out IntPtr buffer);
	...
	internal class TypeFindHelperGetRangeFunctionWrapper {
		...
		public int NativeCallback (IntPtr obj, ulong offset, uint length, out IntPtr buffer)
		{
			try {
				Gst.Buffer mybuffer;

				Gst.FlowReturn __ret = managed (Gst.GLib.Object.GetObject(obj) as Gst.Object, offset, length, out mybuffer);
