...
#region Autogenerated code
	...
	internal delegate int PadLinkFunctionNative(IntPtr pad, IntPtr peer);
	...
	internal class PadLinkFunctionInvoker {
		...
		internal PadLinkFunctionInvoker (PadLinkFunctionNative native_cb, IntPtr data, Gst.GLib.DestroyNotify notify)
		{
		...
		Gst.PadLinkReturn InvokeNative (Gst.Pad pad, Gst.Pad peer)
		{
			Gst.PadLinkReturn result = (Gst.PadLinkReturn) native_cb (pad == null ? IntPtr.Zero : pad.Handle, peer == null ? IntPtr.Zero : peer.Handle);
			return result;
		}
	}
	...
	internal class PadLinkFunctionWrapper {
		...
		public int NativeCallback (IntPtr pad, IntPtr peer)
		{
			try {
				Gst.PadLinkReturn __ret = managed (Gst.GLib.Object.GetObject(pad) as Gst.Pad, Gst.GLib.Object.GetObject(peer) as Gst.Pad);
				if (release_on_call)
					gch.Free ();
				return (int) __ret;
			} catch (Exception e) {
