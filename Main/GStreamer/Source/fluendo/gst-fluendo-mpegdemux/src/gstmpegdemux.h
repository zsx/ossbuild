...
#define GST_FLUPS_DEMUX(obj)              (G_TYPE_CHECK_INSTANCE_CAST((obj), \
                                            GST_TYPE_FLUPS_DEMUX,GstFluPSDemux))
#define GST_FLUPS_DEMUX_CLASS(klass)      (G_TYPE_CHECK_CLASS_CAST((klass), \
                                            GST_TYPE_FLUPS_DEMUX,GstFluPSDemuxClass))
#define GST_FLUPS_DEMUX_GET_CLASS(klass)  (G_TYPE_INSTANCE_GET_CLASS((klass), \
                                            GST_TYPE_FLUPS_DEMUX,GstFluPSDemuxClass))
#define GST_IS_FLUPS_DEMUX(obj)           (G_TYPE_CHECK_INSTANCE_TYPE((obj), \
                                            GST_TYPE_FLUPS_DEMUX))
#define GST_IS_FLUPS_DEMUX_CLASS(obj)     (G_TYPE_CHECK_CLASS_TYPE((klass), \
                                            GST_TYPE_FLUPS_DEMUX))
