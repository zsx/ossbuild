...
/* Default audio sink */
#define DEFAULT_AUDIOSINK "directsound"
...
#define GST_PACKAGE_NAME "GStreamer GNonLin plugin"

/* package origin */
#define GST_PACKAGE_ORIGIN "freedesktop.gstreamer.net"
